...
describe('EventNotificationsV1', () => {
  ...
  describe('getPreDefinedTemplate', () => {
    describe('positive tests', () => {
      function __getPreDefinedTemplateTest() {
        // Construct the params object for operation getPreDefinedTemplate
        const instanceId = 'testString';
        const id = 'testString';
        ...
        const getPreDefinedTemplateResult = eventNotificationsService.getPreDefinedTemplate(
          getPreDefinedTemplateParams
        );

        // all methods should return a Promise
        expectToBePromise(getPreDefinedTemplateResult);
      ...
      test('should prioritize user-given headers', () => {
        ...
        eventNotificationsService.getPreDefinedTemplate(getPreDefinedTemplateParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await eventNotificationsService.getPreDefinedTemplate({});
        } catch (e) {
          err = e;
        }
  ...
  describe('updateEmailSandboxDestination', () => {
    describe('positive tests', () => {
      function __updateEmailSandboxDestinationTest() {
        // Construct the params object for operation updateEmailSandboxDestination
        const instanceId = 'testString';
        const id = 'testString';
        ...
        const updateEmailSandboxDestinationResult =
          eventNotificationsService.updateEmailSandboxDestination(
            updateEmailSandboxDestinationParams
          );

        // all methods should return a Promise
        expectToBePromise(updateEmailSandboxDestinationResult);
      ...
      test('should pass the right params to createRequest with enable and disable retries', () => {
        // baseline test
        __updateEmailSandboxDestinationTest();
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await eventNotificationsService.updateEmailSandboxDestination({});
        } catch (e) {
          err = e;
        }
